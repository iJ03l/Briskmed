...
const Search = () => {
    return (
        ...
        <div className="flex justify-center  items-start Navbar h-screen">
            <div className='image-wrapper w-4/5 h-68 shadow-lg rounded-lg  object-cover flex p-4 items-center justify-auto py-8 px-10 bg-white'>
                <img src={Hospital1} alt="first-black" className=' self-start h-52 w-52 rounded-lg'/>
